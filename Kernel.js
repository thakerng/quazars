...
var Component = require('./Class/Component');
...
var Kernel = (function () {
     ...
     */
    Kernel.setEnvironment = function () {
    ...
    Kernel.decorate = function () {
        ...
        Kernel.app.use(function (req, res, next) {
            ...
            res.render = function (view, options, fn) {
                ...
                if (caps)
                    view = caps[1] + '/views/' + caps[2].replace(/\./g, '/') + EXT;
                else
                    return;
     ...
     * @returns {Kernel}
     */
    Kernel.build = function (sharedApp, config) {
        Kernel.initiate();
     ...
     */
    Kernel.load = function (id, provider) {
     ...
     * @returns {any}
     */
    Kernel.getComponent = function (componentId) {
